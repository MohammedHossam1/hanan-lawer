...
const Hero = () => {
  ...
  return (
    <section className="h-[calc(100dvh-64px)] bg-gradient-hero relative overflow-hidden ">
      {/* Background Patterns */}
            ...
            <div className="relative max-xl:flex flex-col  gap-2 ">
              ...
              <div className="relative z-10 h-full">
                <img
                  ...
                  className="w-full max-w-lg max-h-lg h-[250px] md:h-full object-top object-cover mx-auto rounded-2xl shadow-glow "
                />
              </div>
